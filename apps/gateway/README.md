...
- Only `/ai/copilotkit` GET/POST, `/ai/chat/models` GET, `/ai/chat/credits` GET
  and `/ai/chat/threads` (GET/PATCH/DELETE, with or without a thread id)
  forward to AI. The AI service owns the chat history and the AI-credits read

...
export const config: SheriffConfig = {
  ...
  modules: {
    'apps/web/src/app/domains/<domain>': {
      ...
      // Optional public API of a domain (see sheriff.config.api example in
      // apps/web/docs/architecture-boundaries.md). Only added on explicit request.
  ...
  depRules: {
    ...
    'type:ui': ['type:ui-kit', 'type:data', 'type:util'],
    'type:data': ['type:util'],
    'type:util': [],

    // A domain API republishes selected parts of its own domain.
